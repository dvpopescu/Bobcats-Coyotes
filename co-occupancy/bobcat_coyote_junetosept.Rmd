...
# detection history
spp <- 
  read_excel('bob_coy_data_twoweeks_02162025.xlsx', sheet = 3) %>% 
...
#prey data
prey <-
  read_excel('prey_data_twoweeks_02162025.xlsx', sheet = 3) %>%
...
traps <- 
  read_excel('coys_bobs_trapeffort_by_season.xlsx', sheet = 2) %>% 
...
B_ofNull <- c('~1', '~1',
                      '~1') 
B_Null <- occuMulti(CB_det, B_ofNull, occ_data, method="Nelder-Mead",
...
bobcats_marg <- fitList(B_forest1500, B_forest1000, B_forest500, 
                        ...
                        B_DistanceStreams, B_distmainrds, B_WTD, B_SQ, B_HARE, B_Null)
...
CB_OF_1 <- c('~OpenHabitat1500', '~1',
                 '~1') 
                 
CB_1 <- occuMulti(CB_det, CB_OF_1, occ_data)
summary(CB_1)

CB_OF_2 <- c('~OpenHabitat1500', '~distmainrds',
             '~1') 

CB_2 <- occuMulti(CB_det, CB_OF_2, occ_data)
summary(CB_2)

CB_OF_3 <- c('~OpenHabitat1500', '~OpenHabitat1000',
             '~1') 

CB_3 <- occuMulti(CB_det, CB_OF_3, occ_data)
summary(CB_3)

CB_OF_4 <- c('~OpenHabitat1500', '~DistanceStreams',
             '~1') 
...
CB_OF_5 <- c('~OpenHabitat1500', '~MainRds1500',
             '~1') 

CB_5 <- occuMulti(CB_det, CB_OF_5, occ_data)
summary(CB_5)

CB_OF_6 <- c('~OpenHabitat1500', '~Forest1000',
             '~1') 
...
# create fitlist
CB_marg_mods <- 
  fitList(CB_1, CB_2, CB_3, CB_4, CB_5, CB_6)
...
CB_coocc_1 <- c('~OpenHabitat1500', '~OpenHabitat1000',
             '~WTD.SUM') 
        
CB_CO_1 <- occuMulti(CB_det, CB_coocc_1, occ_data)
summary(CB_CO_1)

CB_coocc_2 <- c('~OpenHabitat1500', '~OpenHabitat1000',
             '~SQ.SUM')

CB_CO_2 <- occuMulti(CB_det, CB_coocc_2, occ_data)
summary(CB_CO_2)

CB_coocc_3 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
             '~HARE.SUM')

CB_CO_3 <- occuMulti(CB_det, CB_coocc_3, occ_data)
summary(CB_CO_3)

CB_coocc_4 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
             '~Forest1500')

CB_CO_4 <- occuMulti(CB_det, CB_coocc_4, occ_data)
summary(CB_CO_4)

CB_coocc_5 <- c('~OpenHabitat1500', '~OpenHabitat1000',
             '~Forest1000')  

CB_CO_5 <- occuMulti(CB_det, CB_coocc_5, occ_data)
summary(CB_CO_5)

CB_coocc_6 <- c('~OpenHabitat1500', '~OpenHabitat1000',
             '~Forest500')

CB_CO_6 <- occuMulti(CB_det, CB_coocc_6, occ_data)
summary(CB_CO_6)

CB_coocc_7 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
             '~OpenHabitat1500')

CB_CO_7 <- occuMulti(CB_det, CB_coocc_7, occ_data)
summary(CB_CO_7)

CB_coocc_8 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
             '~OpenHabitat1000')

CB_CO_8 <- occuMulti(CB_det, CB_coocc_8, occ_data)
summary(CB_CO_8)

CB_coocc_9 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
             '~OpenHabitat500')

CB_CO_9 <- occuMulti(CB_det, CB_coocc_9, occ_data)
summary(CB_CO_9)

CB_coocc_10 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
            '~SHDI_1500') 

CB_CO_10 <- occuMulti(CB_det, CB_coocc_10, occ_data)
summary(CB_CO_10)

CB_coocc_11 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~SHDI_1000') 

CB_CO_11 <- occuMulti(CB_det, CB_coocc_11, occ_data)
summary(CB_CO_11)

CB_coocc_12 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~distmainrds')

CB_CO_12 <- occuMulti(CB_det, CB_coocc_12, occ_data)
summary(CB_CO_12)

CB_coocc_13 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~AllRds1500') 

CB_CO_13 <- occuMulti(CB_det, CB_coocc_13, occ_data)
summary(CB_CO_13)

CB_coocc_14 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~SHDI_500')  

CB_CO_14 <- occuMulti(CB_det, CB_coocc_14, occ_data)
summary(CB_CO_14)

CB_coocc_15 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~AllRds500') 

CB_CO_15 <- occuMulti(CB_det, CB_coocc_15, occ_data)
summary(CB_CO_15)

CB_coocc_16 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~MainRds1500') 

CB_CO_16 <- occuMulti(CB_det, CB_coocc_16, occ_data)
summary(CB_CO_16)

CB_coocc_17 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~MainRds1000') 

CB_CO_17 <- occuMulti(CB_det, CB_coocc_17, occ_data)
summary(CB_CO_17)

CB_coocc_18 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~MainRds500') 

CB_CO_18 <- occuMulti(CB_det, CB_coocc_18, occ_data)
summary(CB_CO_18)

CB_coocc_19 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
            '~DistanceStreams') 

CB_CO_19 <- occuMulti(CB_det, CB_coocc_19, occ_data)
summary(CB_CO_19)

CB_coocc_20 <-  c('~OpenHabitat1500', '~OpenHabitat1000',
            '~AllRds1000')

CB_CO_20 <- occuMulti(CB_det, CB_coocc_20, occ_data)
summary(CB_CO_20)

CB_coocc_21 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~AllRds1000 + ~distmainrds') 

CB_CO_21 <- occuMulti(CB_det, CB_coocc_21, occ_data)
summary(CB_CO_21)

CB_coocc_22 <- c('~OpenHabitat1500', '~OpenHabitat1000',
            '~AllRds1000 + ~SQ.SUM') 
...
co.occ_mods <- 
  fitList(CB_CO_1, CB_CO_2, CB_CO_3, CB_CO_4, CB_CO_5, CB_CO_6, CB_CO_7, CB_CO_8, CB_CO_9, CB_CO_10, CB_CO_11, CB_CO_12, CB_CO_13, CB_CO_14, CB_CO_15, CB_CO_16, CB_CO_17, CB_CO_18,
          CB_CO_19, CB_CO_20, CB_CO_21, CB_CO_22)
...
```{r}
# Coyote Marginal occupancy graph (Open Habitat 1500) ------------------------------
...
new.df.OH1500 <- 
  data.frame(
    expand.grid(
      ...
      OpenHabitat1000 = mean(sites.scaled$OpenHabitat1000),
...
Epsi_C_all <- 
  data.frame(Epsi_C, 
             ...
             OpenHabitat1000 = new.df.OH1500$OpenHabitat1000,
...
#7854 cells in 1500m radius buffer
#1348/7854
#maximum open habitat withing 1500 m buffer is 0.1716323

# combined
Epsi_C_all <- 
  cbind(Epsi_C_all, OH1500)


# graph

C.OH1500.plot <- ggplot(data = Epsi_C_all, aes(x = OH1500, 
                                                          y = Predicted)) +
...
#ggsave("BC_openhabitat1500summer.jpg", height = 5, width = 8, units = 'in')
```

```{r}
# Bobcat Marginal occupancy graph (OpenHabitat1000) ----------------------------
...
new.df.OH1000 <- 
  data.frame(
    expand.grid(
      OpenHabitat1000 = seq(
        min(sites.scaled$OpenHabitat1000), 
        max(sites.scaled$OpenHabitat1000), 
        0.01),
...
Epsi_B <- 
  predict(CB_CO_12, 
          type ="state", 
          species = 'Bobcat',  
          newdata = new.df.OH1000)

# combine predicted data from above with new data frame
Epsi_B_all <- 
  data.frame(Epsi_B, 
             OpenHabitat1500 = new.df.OH1000$OpenHabitat1500,
             OpenHabitat1000 = new.df.OH1000$OpenHabitat1000,
             distmainrds = new.df.OH1000$distmainrds)
...
# combined
Epsi_B_all <- 
  cbind(Epsi_B_all, OH1000)


# graph

B.OH1000.plot <- ggplot(data = Epsi_B_all, aes(x = OH1000, 
                                                          y = Predicted)) +
  ...
  # alter axis labels
  xlab ("Proportion of open habitat within 1000 meters")+
...
#ggsave("BC_openhabitat1000.jpg", height = 5, width = 8, units = 'in')
```


```{r}
# Co-occupancy graphs (distmainrds) -----------------------------------------
...
Epsi_coOcc_BC<- 
  predict(CB_CO_12, 
          ...
          newdata = CB_CO_12_distr.df)

# combine predicted data from above with new data frame
Epsi_coOcc_BC <- 
  data.frame(Epsi_coOcc_BC,
             OpenHabitat1500 = CB_CO_12_distr.df$OpenHabitat1500,
             distmainrds = CB_CO_12_distr.df$distmainrds,
             OpenHabitat1000 = CB_CO_12_distr.df$OpenHabitat1000)

# combine raw CLC_forest values with predicted values for coyote and bobcat in new data frame
Epsi_coOcc_BC <- 
  cbind(Epsi_coOcc_BC, distroads)
...
# graph
Epsi_coOcc_BC.plot <- ggplot(data = Epsi_coOcc_BC, aes(x = distroads, 
                                                                 y = Predicted)) + 
  ...
  # alter axis labels
  labs(x = (expression(paste("Distance to nearest main road (m)"))),
  ...
  coord_cartesian(ylim = c(0,1),
                  xlim = c(130,13200)) +
  scale_x_continuous(breaks = seq(0,13200, 3000)) +
...
#ggsave("BC_cooccurencemainrdssummer.jpg", height = 5, width = 8, units = 'in')
```

```{r}
# Conditional occupancy graph (distmainrds)-----------------------------------
...
condOcc.plot <- ggplot(data = Epsi_condOcc_all, aes(x = distroads, 
                                                                  y = Predicted, 
                                                                  group = conditional)) +
...
#ggsave("BC_condoccmainrds.jpg", height = 8, width = 10, units = 'in')
```
